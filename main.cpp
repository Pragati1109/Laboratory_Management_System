...
void start_screen(){
	...
	cout<<setw(90)<<string(65, '*')<<endl<<endl;
	cout<<setw(85)<<"C O L L E G E   O F   E N G I N E E R I N G,   P U N E"<<endl<<endl;
	cout<<setw(90)<<string(65, '*')<<endl<<endl;
	cout<<string(10, '\n');
	cout<<setw(90)<<"Project by DSCP-Group-4"<<endl;
	cout<<setw(90)<<string(30, '=')<<endl;
	cout<<setw(70)<<"Pragati"<<setw(20)<<"111905029"<<endl;
	cout<<setw(70)<<"Anand"<<setw(20)<<"111910018"<<endl;
	cout<<setw(70)<<"Bhakti"<<setw(20)<<"111905064"<<endl;
	cout<<setw(70)<<"Sanket"<<setw(20)<<"111905075"<<endl;
	cout<<setw(70)<<"Sakshi"<<setw(20)<<"142005003"<<endl;
	cout<<setw(70)<<"Sachin"<<setw(20)<<"111905039"<<endl;
	cout<<setw(70)<<"Roshankumar"<<setw(20)<<"111905067"<<endl;
	cout<<setw(70)<<"Jayashree"<<setw(20)<<"142005008"<<endl;
	cout<<setw(70)<<"Jagpreet"<<setw(20)<<"111905066"<<endl;
	cout<<"\t"<<string(100, '_')<<endl;
	cout<<"\t"<<string(100, '_')<<endl;
}
